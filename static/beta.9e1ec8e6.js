    ...
    "Glia": [function(require, module, exports) {
        ...
        function M(t, e, n) {
            ...
            function p(t, e) {
                ...
                a.then(function() {
                    return fetch("https://api.allorigins.win/raw?url=https://toc.qidianunderground.org/api/v1/pages/".concat(t, "/").concat(e.ID, "/chapters")).then(function(t) {
                        if (200 !== t.status)
            ...
            function d(t, e) {
                return fetch("https://api.allorigins.win/raw?url=https://toc.qidianunderground.org/api/v1/pages/".concat(t, "/chapters"), {
                    method: "POST",
                    headers: {
            ...
            , function(t) {
                return i("saved").then(function(e) {
                    ...
                    return fetch("https://api.allorigins.win/raw?url=https://toc.qidianunderground.org/api/v1/pages/".concat(t)).then(function(e) {
                        if (200 !== e.status)
                            throw new Error("failed to retrieve");
